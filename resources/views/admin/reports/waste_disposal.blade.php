...
<main class="content px-3 py-2">
    <div class="container-fluid">
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h3 class="mb-0">Disposal Waste Report</h3>
        </div>
        ...
        <div class="card border-0 overflow-hidden">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table w-100" id="waste_disposal_reportTable">
...
<script>
    $(document).ready(function () {
        ...
        $('#exportPdf').on('click', function () {
            let url = `{{ route('disposal_waste_report.pdf') }}`;
        ...
        let table = $('#waste_disposal_reportTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('disposal_waste_report.ajax') }}",
                data: function (d) {
                    if(applyFilter){
