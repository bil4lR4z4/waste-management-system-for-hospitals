...
<script>
    $(document).ready(function () {
        ...
        $('#exportPdf').on('click', function () {
            let url = `{{ route('waste_report.pdf') }}`;
            ...
            if (applyFilter) {
                ...
                url += `?from_date=${from_date}&to_date=${to_date}&city=${city}&hospital=${hospital}`;
            }
